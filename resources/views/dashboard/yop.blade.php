                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="p-3 border rounded">
                        ...
                        <span class="fs-18 text-primary">Trimeste</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="tab-pane fade show active" id="Monthly">
                  <div class="row">
                    <div class="col-sm-4 mb-md-0 mb-3">
                      <div class="p-3 border rounded">
                        <h3 class="fs-32 text-black font-w600 mb-1">{{$nbAgence}}</h3>
                        <span class="fs-18 text-primary"> Agence </span>
                      </div>
                    </div>
                    <div class="col-sm-4 mb-md-0 mb-3">
                      <div class="p-3 border rounded">
                        <h3 class="fs-32 text-black font-w600 mb-1">{{$nbProduct}}</h3>
                        <span class="fs-18 text-primary">Produit</span>
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <div class="p-3 border rounded">
                        <h3 class="fs-32 text-black font-w600 mb-1">{{$nbEmploye}}</h3>
