          ...
          <div class="card">
            <div class="card-header d-sm-flex flex-wrap d-block pb-0 border-0">
              <div class="me-auto pe-3">
                <h4 class="text-black fs-20"> Contrats  </h4>
                <p class="fs-13 mb-0 text-black"> Nombre de contrat en fonction de la période </p>
              </div>
            </div>
            <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-6 mb-md-0 mb-3">
                      <div class="p-3 border rounded">
                        <h3 class="fs-20 text-black font-w600 mb-1">{{$nbContratMois}} </h3>
                        <span class="fs-18 text-primary">Mois</span>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="p-3 border rounded">
                        <h3 class="fs-20 text-black font-w600 mb-1"> {{$nbContratTrimestre}}  </h3>
