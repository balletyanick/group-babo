...
<div class="content-body">
  <div class="container-fluid">
    @if(Auth::user()->permission("STATISTIQUE GENERALE"))
      <div class="row">
            ...
            <div class="card-body" id="box_yan">	
              <div class="media align-items-center">
                <div class="media-body mr-2">
                  <h2 class="text-white font-w600"> {{$nbCustomer}}</h2>
                  <span class="text-white"> Total des Clients </span>
                </div>
                <div class="d-inline-block position-relative donut-chart-sale">
                  <span class="donut1" style="color: white" data-peity='{ "fill": ["rgb(255, 255, 255)", "rgba(255, 255, 255, 0)"],   "innerRadius": 41, "radius": 10}'>6/8</span>
