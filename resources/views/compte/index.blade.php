            ...
            <div class="card-body" id="box_yan">	
              <div class="media align-items-center">
                <div class="media-body mr-2">
                  ...
                  <span  class="text-white">  Total à gagner </span>
                </div>
        ...
        <div class="col-xl-3 col-xxl-6 col-sm-6">
          <div class="card grd-card">
            <div class="card-body" id="box_yan">	
              <div class="media align-items-center">
                <div class="media-body mr-2">
                  <h2 class="text-white font-w600"> {{$nombre_contrats}} </h2>
                  <span class="text-white"> Nombre de Contrats </span> 
                </div>
                <div class="d-inline-block position-relative donut-chart-sale">
        ...
        <div class="col-xl-3 col-xxl-6 col-sm-6">
          <div class="card grd-card">
            <div class="card-body" id="box_yan">	
              <div class="media align-items-center">
                <div class="media-body mr-2">
                  <h2 class="text-white font-w600"> {{$total_vehicules}} </h2>
                  <span class="text-white"> Nombre de Véhicule </span>
                </div>
                <div class="d-inline-block position-relative donut-chart-sale">
        ...
        <div class="col-xl-12 col-xxl-12 col-sm-12">
          <div class="card grd-card">
            <div class="card-body" id="box_yan">	
              <div class="media align-items-center">
                <div class="media-body mr-2">
                  <h2 class="text-white font-w600"> 25 220 186 08 </h2>
                  <span  class="text-white">  Call Center  </span>
                </div>
                <div class="d-inline-block position-relative donut-chart-sale">
                  <span style="color: white" class="donut1" data-peity='{ "fill": ["rgb(255, 255, 255)", "rgba(255, 255, 255, 0)"],   "innerRadius": 41, "radius": 10}'>7/8</span>
                  <small class="text-primary">
