                            ...
                            <form action="{{route('user.save')}}" class="add_user">
                                ...
                                <div class="row form-material">
                                    ...
                                    <div class="col-xl-3 col-xxl-6 col-md-6 mb-3">
                                        ...
                                        <select name="role_id" id="role_id" class="form-control default-select form-control-sm" disabled>
                                            <option value="b5839acb-be4e-4cd5-a0ca-ab26e45c1ad2" selected>PARTENAIRE</option>
                                        </select>
