            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{route('contrat-employe.save')}}" class="add_contratsemploye">
                                @csrf
                                ...
                                <div class="row form-material">
                                    ...
                                    <div class="col-xl-3 col-xxl-6 col-md-6 mb-3">
                                        ...
                                        <input type="number" name="time_contrat"  class="form-control" required>
                                    </div>
                                    ...
                                    <div class="col-xl-12 col-xxl-12 col-md-12 mt-3">
                                        <button id="add_contratsemploye" class="btn btn-primary"> Enregistrer </button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
@section('script')
    ...
    <script>
        ...
        $('.add_contratsemploye').submit(function(e){

            e.preventDefault();

            var form = new FormData($(this)[0]);

            var buttonDefault = $('#add_contratsemploye').text();
            var button = $('#add_contratsemploye');
