                            ...
                            <form action="{{route('contrat.save_edit')}}" class="edit_contrat">
                                ...
                                <div class="row form-material">
                                    <div class="col-xl-12 col-xxl-12 col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control bg-light" value="{{$contrat->customer->first_name}} {{$contrat->customer->last_name}}" readonly>
                                    </div>
                                    ...
                                    <div class="col-xl-3 col-xxl-6 col-md-6 mb-3">
                                        ...
                                        <input type="number" name="quantite" value="{{$contrat->quantite}}"  class="form-control" required>
                                    </div>
                                    ...
                                    <div class="col-xl-12 col-xxl-12 col-md-12 mb-3">
                                        ...
                                        <input type="text" value="{{$contrat->note}}" class="form-control" name="note">
                                    </div>
                                    
                                    <div class="col-xl-12 col-xxl-12 col-md-12 mt-3">
                                        <button id="edit_contrat" class="btn btn-primary"> Enregistrer </button>
                                    </div>
                                </div>
                            </form>
                        </div>
