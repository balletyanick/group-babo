            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{route('pret.save')}}" class="add_pret">
                                @csrf
                                    ...
                                    <div class="col-xl-12 col-xxl-12 col-md-12 mb-3">
                                        ...
                                        <select id="mySelect" name="contrat_id" class="form-control">
                                            @foreach($contrat as $contrats)
                                                <option value="{{$contrats->id}}" {{$contrats->id==$pret->contrat_id ? 'selected' : ''}}> {{$contrats->numero_contrat}} - {{$contrats->user->first_name}} {{$contrats->user->last_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
